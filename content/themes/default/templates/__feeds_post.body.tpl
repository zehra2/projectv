      ...
      <div class="post-product-container">
        ...
        <div class="single-product-thumb">
          {if $post['product']['mediatype'] == 'youtube' }
            <iframe id="single-product-video-iframe" src="{$post['product']['youtube_url']}" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"> </iframe>
          {elseif $post['product']['mediatype'] == 'facebook' }
            <iframe id="single-product-video-iframe" src="https://www.facebook.com/plugins/video.php?href={$post['product']['facebook_url']}" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"> </iframe>
          {else}
