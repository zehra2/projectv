{if $_tpl == "featured"}
  <div class="{if $_iteration == 1}col-sm-12 col-md-8 col-lg-6{else}col-sm-6 col-md-4 col-lg-3{/if}">
    <a href="{if $article['needs_payment'] || $article['needs_subscription'] || $article['needs_pro_package']}{$system['system_url']}/posts/{$article['post_id']}{else}{$system['system_url']}/blogs/{$article['post_id']}/{$article['article']['title_url']}{/if}" class="blog-container {if $_iteration == 1}primary{/if}">
