{strip}
  ...
  {assign var=core_js_id value=10|mt_rand:200000000}

  <!-- System [JS] -->
  <script src="{$system['system_url']}/includes/assets/js/core/core.js?v={$core_js_id}" {if !$user->_logged_in}defer{/if}>
  ...
  {if $user->_logged_in}
    ...
    <script src="{$system['system_url']}/includes/assets/js/custom/custom.js?v={$unique_id}"></script>
