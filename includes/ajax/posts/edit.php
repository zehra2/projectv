...
try {
  ...
  switch ($_POST['handle']) {
    ...
    case 'product':
      ...
      if (!isset($_POST['name']) || !isset($_POST['price']) || !isset($_POST['message'])) {
        _error(400);
      }
      /* check product name */
      ...
      }elseif($_POST['mediatype'] == 'youtube'){
        
        /* check youtube URL */
        if(!empty($_POST['youtubeurl'])){
          $valid_youtube_url = $user->isValidYoutubeURL($_POST['youtubeurl']);
